...
public class AlarmBroadcastReceiver extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        if (intent.getAction().equals("android.intent.action.BOOT_COMPLETED")) {
            // Stellen Sie hier den Alarm ein.
            Toast.makeText(context, "Alarm hat gerade geklingelt...", Toast.LENGTH_SHORT).show();
        }
        ...
        Toast.makeText(context, "Rundfunkempfänger genannt", Toast.LENGTH_SHORT).show();
